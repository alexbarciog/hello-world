-- Remove old single-run cron job
SELECT cron.unschedule('process-signal-agents-daily');

-- Create 5 daily runs at 07:00, 09:00, 12:00, 15:00, 18:00 UTC
SELECT cron.schedule(
  'process-signal-agents-07',
  '0 7 * * *',
  $$
