...
export default function CreateCampaign() {
  ...
  return (
    <div className="min-h-full bg-[#f7f8fa] px-4 md:px-8 py-6">
      {/* Page Header */}
          ...
          {STEP_LABELS.map((s, i) => (
            <div key={s.num} className="flex items-center flex-1">
              <div className="flex items-center gap-2.5">
                ...
                <span className={`text-sm whitespace-nowrap ${step >= s.num ? "text-gray-900 font-medium" : "text-gray-400"}`}>
                  {s.label}
                </span>
              </div>
              {i < STEP_LABELS.length - 1 && (
                <div className="flex-1 mx-4 h-px bg-gray-200 relative overflow-hidden">
                  <div
                    className="absolute inset-y-0 left-0 bg-gray-900 transition-all duration-300"
          ...
          <div className="p-6 md:p-8">
            ...
            {step === 1 && (
              <div className="space-y-6">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-700 mb-3">Lead Source Type</p>
                    ...
                    {[
                      ...
                      >
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                          sourceType === opt.type ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-500"
                        }`}>
                        ...
                        <div className="ml-auto">
                          <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                            sourceType === opt.type ? "border-gray-900" : "border-gray-300"
                          }`}>
                ...
                {sourceType === "agent" && (
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-2">AI Agent</p>
                        ...
                        {[
                          ...
                          <div key={group.label}>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {group.items.map((t) => (
                                <span key={t} className="text-xs px-2.5 py-1 rounded-full border border-gray-200 text-gray-700 bg-white">{t}</span>
                              ))}
                            </div>
                          </div>
                        ))}
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                  <p className="text-xs font-medium text-gray-500 mb-2">Company Website</p>
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 rounded-lg px-4 py-2.5 disabled:opacity-40 transition-colors"
                    >
                      {analyzingWebsite ? (
                ...
                {/* Value Proposition */}
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                  <p className="text-xs font-medium text-gray-500 mb-2">Value Proposition</p>
