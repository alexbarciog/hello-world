    ...
    <div className="min-h-full px-6 py-6 bg-white flex gap-6">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <MetricCard title="Leads Engaged" value={leadsEngaged} loading={statsLoading} bgColor="bg-[#E6F1FD]" />
          <MetricCard title="Conversations" value={conversations} loading={statsLoading} bgColor="bg-[#e8f0fb]" />
          <MetricCard title="Active Signals" value={activeSignals} loading={false} bgColor="bg-[#E6F1FD]" />
        </div>
