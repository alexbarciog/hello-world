            ...
            <>
              ...
              <div className="mb-5 rounded-lg p-3.5 bg-muted border border-border">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg text-sm font-medium border border-border bg-background text-foreground hover:bg-muted transition-colors disabled:opacity-60">
                  {googleLoading ? (
