...
const HeroFloatingCards = () => {
  return (
    <div className="relative w-full h-full min-h-[560px]">
      {/* Main lead card */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[340px] bg-white rounded-xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.25)] p-5 z-10">
        ...
        <div className="rounded-lg bg-neutral-50 p-3 mb-3">
      ...
      <div className="absolute top-[6%] left-[-4%] sm:left-[-2%] bg-white rounded-lg shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float">
      ...
      <div
        className="absolute top-[18%] right-[-2%] sm:right-[0%] bg-white rounded-lg shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float"
      ...
      <div
        className="absolute bottom-[14%] left-[0%] sm:left-[2%] bg-white rounded-lg shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float"
      ...
      <div
        className="absolute bottom-[6%] right-[-2%] sm:right-[2%] bg-white rounded-lg shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float"
