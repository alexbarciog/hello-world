  ...
  return (
    <div className="relative w-full h-full min-h-[560px]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[340px] bg-white rounded-none shadow-[0_20px_60px_-15px_rgba(0,0,0,0.25)] p-5 z-10">
        ...
        <div className="rounded-none bg-neutral-50 p-3 mb-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="bg-[#0a0a0a] text-white text-[12px] font-semibold rounded-none px-4 py-2 hover:bg-neutral-800 transition-colors">
            Reach out
          </button>
        </div>
      </div>
      ...
      <div className="absolute top-[6%] left-[-4%] sm:left-[-2%] bg-white rounded-none shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float">
      ...
      <div
        className="absolute top-[18%] right-[-2%] sm:right-[0%] bg-white rounded-none shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float"
      ...
      <div
        className="absolute bottom-[14%] left-[0%] sm:left-[2%] bg-white rounded-none shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float"
        style={{ animationDelay: "2s" }}
      >
        <div className="w-8 h-8 rounded-none bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center text-[10px] font-bold text-white shrink-0">
          RB
        </div>
        <div>
      ...
      <div
        className="absolute bottom-[6%] right-[-2%] sm:right-[2%] bg-white rounded-none shadow-[0_12px_40px_-10px_rgba(0,0,0,0.2)] px-3.5 py-2.5 flex items-center gap-2.5 z-20 animate-float"
