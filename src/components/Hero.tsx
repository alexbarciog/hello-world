      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 pt-10 md:pt-24 pb-12 md:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-12 lg:gap-8 items-center">
          ...
          <div className="relative z-10">
            {/* Urgency badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-3 py-1.5 md:px-4 md:py-2 mb-5 md:mb-8 shadow-sm animate-fade-in-up">
            ...
            <h1
              className="font-medium tracking-[-0.03em] leading-[1.05] md:leading-[1.02] text-[#0a0a0a] animate-fade-in-up"
              style={{ animationDelay: "80ms", fontSize: "clamp(2rem, 5.6vw, 4.75rem)" }}
            >
            ...
            <p
              className="mt-5 md:mt-7 text-base md:text-xl text-neutral-500 leading-relaxed max-w-xl animate-fade-in-up"
            ...
            <div
              className="mt-7 md:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 animate-fade-in-up"
