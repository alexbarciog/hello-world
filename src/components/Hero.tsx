  ...
  return (
    <section className="relative min-h-[88vh] md:min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-7xl mx-auto w-full pt-24 md:pt-36">
        ...
        <h1 className="text-[2.5rem] sm:text-5xl md:text-7xl lg:text-[5.5rem] font-medium text-white leading-[1.08] md:leading-[1.05] tracking-tight mb-6 text-center animate-fade-in-up" style={{ animationDelay: "80ms" }}>
          <span className="block">Find people</span>
          <span className="block">already looking for</span>
          <span className="block">what you offer</span>
          <span className="flex items-center justify-center gap-2 md:gap-3 text-white/70 mt-1">
            <span>on</span>
            <span className="inline-flex items-center justify-center w-9 h-9 sm:w-12 sm:h-12 md:w-16 md:h-16">
