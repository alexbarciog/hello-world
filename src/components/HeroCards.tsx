    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full">
      ...
      <div className="rounded-2xl bg-white/80 backdrop-blur-sm border border-white/50 shadow-lg p-5 text-left flex flex-col gap-4">
        ...
        <div className="bg-muted/40 rounded-xl p-3 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-xs font-bold text-white shrink-0">MC</div>
        ...
        <div className="mt-auto pt-2 space-y-2">
          ...
          <div className="flex gap-2">
            <button className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold px-3 py-2 rounded-lg bg-foreground text-background">
              <Download className="w-3 h-3" /> Save to CRM
            </button>
            <button className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-medium px-3 py-2 rounded-lg border border-border text-foreground">
