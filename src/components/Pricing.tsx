    ...
    <section id="pricing" className="py-20 md:py-32 px-6 bg-background">
      <div ref={ref} className="reveal-up max-w-5xl mx-auto">
        ...
        <div className="max-w-md mx-auto">
          <div className="rounded-3xl bg-[#f5f5f5] p-8 md:p-10 flex flex-col">
            ...
            <div className="flex items-baseline gap-1 mb-8">
              <span className="text-5xl font-bold" style={{ color: "hsl(var(--aeline-dark))" }}>$97</span>
            ...
            {isActive ? (
              ...
              <button onClick={handleCheckout} disabled={loading} className="btn-cta w-full justify-center">
