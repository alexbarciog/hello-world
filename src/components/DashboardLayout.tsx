    ...
    <div className="flex h-screen overflow-hidden bg-white">
      ...
      <aside className="hidden md:flex flex-col shrink-0 border-r border-gray-100 bg-white w-[220px]">
                  ...
                  >
                    {isExpandable ? (
                      <span
                        ...
                        className="w-3.5 flex items-center justify-center shrink-0 text-black/20 transition-colors"
                      >
        ...
        <div className="px-3 py-3 space-y-1 border-t border-gray-100">
          ...
          >
            <span className="w-3.5 shrink-0" />
            <img src={supportIcon} alt="Support" <img src={supportIcon} alt="Support" className="w-5 h-5 shrink-0" /> />
