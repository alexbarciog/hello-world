...
const testimonials = [
  {
    ...
    quote: "I used to lose Tuesday mornings digging through LinkedIn comments. Two weeks in, Intentsly flagged a post from a founder venting about the exact problem we fix. One message later, we had a $24k ARR deal in motion.",
    feedback: "Closed $24k ARR from one signal",
  },
  {
    name: "Marco P",
    role: "Growth Lead, Fintech",
    quote: "Cold email was dead for us. 4% reply rate on a good day. Now our first line references something the prospect actually said online — not their job title. Replies jumped to 31% and people book calls while we're still in the thread.",
    feedback: "Reply rate: 4% → 31% in 30 days",
  },
  {
    name: "Samantha R",
    role: "CEO, SaaS",
    quote: "Most 'AI outreach' tools feel like black boxes. Intentsly shows me the actual post or comment that triggered the lead. My reps stop guessing what to say and just join the conversation that's already happening.",
    feedback: "Sales cycle shortened by ~12 days",
  },
  {
    name: "David H",
    role: "Head of Sales, Agency",
    quote: "We had three tabs open just to figure out who to contact. Now LinkedIn, Reddit, and X roll into one ranked list with intent scores. My team spends their day talking to the right people instead of building spreadsheets.",
    feedback: "Rep productivity up 2.3x",
  },
  {
    name: "Chen M",
    role: "RevOps, Enterprise",
    quote: "Finally, a signal tool that doesn't flood Salesforce with junk. Every lead card has company, role, signal source, and why the AI flagged it. I can actually explain pipeline to the board now.",
    feedback: "Pipeline attribution finally clean",
  },
  {
    name: "Isabella K",
    role: "Startup Founder",
    quote: "I braced myself for another week-long setup. Had my first agent running the same afternoon I signed up. Support even answered my weird question about Reddit keyword syntax in under 10 minutes.",
    feedback: "First qualified meeting in 48 hours",
  },
];
